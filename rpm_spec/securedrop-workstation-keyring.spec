Name:       securedrop-workstation-keyring-dev
Version:    0.1.0
Release:    1%{?dist}
Summary:    SecureDrop Workstation Keyring (dev - nightly)
...
%description
This package contains the SecureDrop Test Key and .repo file used to bootstrap a development installation of SecureDrop Workstation.
...
install -m 644 files/securedrop-workstation-dom0-dev.repo %{buildroot}/etc/yum.repos.d/
